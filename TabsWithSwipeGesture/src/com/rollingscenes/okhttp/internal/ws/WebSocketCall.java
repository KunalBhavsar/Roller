...
import com.rollingscenes.okhttp.Call;
import com.rollingscenes.okhttp.Callback;
...
import com.rollingscenes.okhttp.internal.NamedRunnable;
...
public class WebSocketCall {
  ...
  WebSocketCall(OkHttpClient client, Request request, Random random) {
    ...
    client.setProtocols(Collections.singletonList(com.rollingscenes.okhttp.Protocol.HTTP_1_1));
